## easy-java
You can easily install the full version of Java or even multiple versions of Java and work with them at the same time, each with a different version installed. It is only supported on Linux systems such as: debian, ubuntu and termux.

### Tool tested on
this tool has been tested on systems such as:
